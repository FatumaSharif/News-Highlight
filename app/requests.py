...
def get_sources(category):
    ...
    with urllib.request.urlopen(get_sources_url, context=context) as url:
...
def get_article(id):
    ...
    with urllib.request.urlopen(get_article_url, context=context) as url:
...
def process_article(article_list):
    ...
    for article_item in article_list:
        idy = article_item.get('source[name]')
